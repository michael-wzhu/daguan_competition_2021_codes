...
#    采用统一的脱敏编码形式；
from src.classic_models.text_utils import split_sent
...
if __name__ == "__main__":
    ...
    from_json_dir = "./datasets/无监督数据/jsonline/datagrand_2021_unlabeled_data.json"
    # to_txt_dir = "./datasets/无监督数据/txt_format/unlabeled_corpus_%d.txt" % 1
    # jsonline2txt(from_json_dir, to_txt_dir, 0, 2)

    num_threads = 16
    for i in range(num_threads):
        to_txt_dir_ = "./datasets/无监督数据/txt_format/unlabeled_corpus_%d.txt" % i
